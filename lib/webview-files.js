...
// 粘贴决策/拖拽插入/防误跳转钩子:webview guest 与独立页面窗口共用
function attachPasteHooks(contents, { notifyResult }) {
...
// 为 webview guest 挂载钩子
function attachWebContentsHooks(contents, opts) {
  if (contents.getType() !== 'webview') return;
  attachPasteHooks(contents, opts);
}

module.exports = { attachWebContentsHooks, attachPasteHooks, readClipboardFilePaths };
